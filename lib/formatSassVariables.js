  ...
  root.walkDecls(function (decl) {
    if (isSassVariable(decl)) {
      ...
      if (!isDataUrl) {
        ...
        // TODO: This causes map-get values to line up in unwanted
        // manner, so disabling
        // Issue: Variables declared as Map are forcely inlined. #331
        // @link https://github.com/morishitter/stylefmt/issues/331
